...
public class CartController {
	...
	public void addToCart(
	    ...
	    cartService.updateCartItem(customerId, customerName, cartRequest.getSkuCode(), cartRequest.getQuantity());
	}

	
    @GetMapping
    public List<CartResponse> getCartItems(@RequestHeader("X-USER-ID") Integer customerId) {
